...
public class LocatedBlock
{
	...
	{
		return new StringBuilder( "LocatedBlock [block=" ).append( block ).append( ", meta=" ).append( blockMeta ).append( ", coords=[" )
				.append( coords.getX() ).append( ", " ).append( coords.getY() ).append( ", " ).append( coords.getZ() ).append( "]]" ).toString();
	}
