...
public class EntityParachute extends Entity
{
	...
	{
		this(world);
		Vec3 vec = new Vec3(x - ship.getShipChunk().getCenterX(), y - ship.getShipChunk().minY(), z - ship.getShipChunk().getCenterZ());
		vec = vec.rotateYaw((float) Math.toRadians(ship.rotationYaw));
