...
public class ContainerHelm extends Container
{
	...
	{
		return player.worldObj.getTileEntity(tileEntity.getPos()) == tileEntity && player.getDistanceSq(tileEntity.getPos().getX(), tileEntity.getPos().getY(), tileEntity.getPos().getZ()) < 25D;
	}
